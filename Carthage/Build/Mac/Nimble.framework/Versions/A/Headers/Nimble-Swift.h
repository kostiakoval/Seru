...
- (BOOL)matches:(NSObject * (^)(void))actualBlock failureMessage:(FailureMessage *)failureMessage location:(SourceLocation *)location;
- (BOOL)doesNotMatch:(NSObject * (^)(void))actualBlock failureMessage:(FailureMessage *)failureMessage location:(SourceLocation *)location;
@property (nonatomic, readonly, copy) NMBObjCRaiseExceptionMatcher * (^ named)(NSString *);
@property (nonatomic, readonly, copy) NMBObjCRaiseExceptionMatcher * (^ reason)(NSString *);
@property (nonatomic, readonly, copy) NMBObjCRaiseExceptionMatcher * (^ userInfo)(NSDictionary *);
@end
...
@interface NMBWait
+ (void)untilTimeout:(NSTimeInterval)timeout action:(void (^)(void (^)(void)))action file:(NSString *)file line:(NSUInteger)line;
+ (void)until:(void (^)(void (^)(void)))action file:(NSString *)file line:(NSUInteger)line;
@end
